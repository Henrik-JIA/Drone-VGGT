...
def find_duplicate_points(
    ...
    Returns:
        映射字典 {points2_id: points1_id}，表示points2中的点与points1中哪个点重复
    """
...
def boundary_aware_filter(
    ...
    Args:
        ...
        density_threshold_ratio: 密度阈值比例，小于 (全局中位数密度 * ratio) 的点将被移除
        verbose: 是否打印详细信息
...
def statistical_outlier_removal(
    ...
    如果该距离大于全局平均距离 + std_ratio * 标准差，则认为是离群点。
...
def smooth_boundary_points(
    ...
    Args:
        ...
        smoothing_radius: 平滑搜索半径
        smoothing_strength: 平滑强度 (0-1)，0=不平滑，1=完全移动到邻域平均位置
        verbose: 是否打印详细信息
